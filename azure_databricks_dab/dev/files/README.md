# azure_databricks_dab_101

The 'azure_databricks_dab_101' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/azure_databricks_dab_101/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] azure_databricks_dab_101_etl` to your workspace.
